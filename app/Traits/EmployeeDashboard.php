...
trait EmployeeDashboard
{
    ...
    public function employeeDashboard()
    {
        ...
        // Deal Data
        //edited by muhssin on 02-09-2024
        //if (!is_null($this->leadAgent)) {
            $this->deals = Deal::select('deals.*', 'pipeline_stages.slug')->with('leadAgent', 'leadStage')->join('pipeline_stages', 'pipeline_stages.id', 'deals.pipeline_stage_id')
                ->get();
