...
<!-- NAV ITEM - File manager updated by muhssin on 10-09-2024-->
@if (in_array(Auth::user()->id, [1,4]) && $sidebarUserPermissions['view_order'] != 5 && $sidebarUserPermissions['view_order'] != 'none')
        <x-menu-item icon="cart3" text="File Manager" :link="route('filemanager.index')">
            <x-slot name="iconPath">
                <path
