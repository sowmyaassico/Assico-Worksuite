...
<div class="tab-pane fade show active" role="tabpanel" aria-labelledby="nav-email-tab">
    ...
    || ($addTaskFilePermission == 'both' && (in_array(user()->id, $taskUsers) || $task->added_by == user()->id))
        ...
        <div class="p-20">
            ...
            <div class="row">
                <div class="col-md-12">
                    <a class="f-15 f-w-500" href="javascript:;" id="add-task-file"><i
                            ...
                            <!--added by muhssin on 28-08-2024-->
                            <br><span id="drpfilesize"></span>
                            <!--end-->
                </div>
            </div>
            ...
            @if ($task->approval_send == 1 && $isEmployee && !$isAdmin)
...
<script>
    $(document).ready(function () {
        ...
        $('#add-task-file').click(function () {
            if (send_approval == 1 && employee == 1 && admin != 1) {
        ...
        if (add_task_files == "all" || add_task_files == "added") {
            //added by muhssin on 28-08-2024
            $('#drpfilesize').text('Max file size is '+DROPZONE_MAX_FILESIZE+' MB');
            //end
