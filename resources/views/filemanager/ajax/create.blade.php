        ...
        <form id="resource-form" method="post" autocomplete="off" novalidate="novalidate" enctype="multipart/form-data">
            ...
            <div class="modal-body">
                ...
                <div class="mb-3">
                    ...
                    <input type="input" id="version" name="version" value="{{ old('version', $obj->version) }}" class="form-control height-35 f-14" required>
                </div>
                @else
                <div class="mb-3">
                    <label class="form-label" for="name">Folder Name</label>
                    <input type="text" id="document" name="document" value="{{ old('version', $obj->version) }}" class="form-control height-35 f-14" required>
                </div>
...
$(document).ready(function() {
    $("#resource-form").submit(function(event) { 
        event.preventDefault();
            ...
            $.ajax({
                type: "POST",
                url: "{{ route('filemanager.create.update.post') }}",
                processData: false,
                contentType: false,
                data: formData,
