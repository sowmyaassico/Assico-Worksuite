        ...
        <div class="d-grid d-lg-flex d-md-flex action-bar">
            <div id="table-actions" class="flex-grow-1 align-items-center mb-2 mb-lg-0 mb-md-0">
                @if($parent->parent_id == 0)
                    <x-forms.link-secondary :link="route('filemanager.index', [1])"
                        class="mr-3 float-left mb-2 mb-lg-0 mb-md-0" icon="arrow-left">
                        Back
                    </x-forms.link-secondary>
                @else
                    <x-forms.link-secondary :link="route('filemanager.list.index', [1, $parent->parent_id])"
                        class="mr-3 float-left mb-2 mb-lg-0 mb-md-0" icon="arrow-left">
                        Back
                    </x-forms.link-secondary>
                @endif    
                    <x-forms.link-primary :link="route('filemanager.list.create.update', [0,1, $parent->id])"
                        class="mr-3 openRightModal float-left mb-2 mb-lg-0 mb-md-0" icon="plus">
                        Add Folder
                    </x-forms.link-primary>
                    <x-forms.link-secondary :link="route('filemanager.list.create.update', [0,2,$parent->id])"
...
function addResource(app_id, id, type) {
 ...
 function loadResources(){ //alert("sss");
    var datatable = $('#datatable_resource').DataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: "{{ route('filemanager.list.list',[1, $parent->id]) }}",
                columns: [
