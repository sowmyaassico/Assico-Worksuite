            ...
            <div class="add-client bg-white rounded">
                ...
                <div class="row pl-20 pr-20">
                    ...
                    <div class="col-md-3">
                        ...
                        fieldName="exchange_rate" fieldRequired="true" :fieldValue="(isset($projectName) ? $project->currency->exchange_rate : (isset($invoice) ? $invoice->currency->exchange_rate : $companyCurrency->exchange_rate))" fieldReadOnly="true"
