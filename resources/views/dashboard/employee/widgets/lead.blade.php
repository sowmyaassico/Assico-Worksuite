{{-- Edited by muhssin on 02-09-2024 : previous code @if (in_array('lead', $activeWidgets) && $leadAgent && in_array('leads', user_modules()))--}}
@if (in_array('lead', $activeWidgets) && (\Auth::user()->roles[0]->id == 1) && in_array('leads', user_modules()))
