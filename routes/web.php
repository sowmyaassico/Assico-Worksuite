...
Route::group(['middleware' => 'auth', 'prefix' => 'account'], function () {
    ...
    //Added by muhssin
    Route::get('filemanager/index/{companyidid?}', [FileManagerController::class, 'index'])->name('filemanager.index');
    Route::get('filemanager/create-update/{companyidid?}/{id?}/{type?}', [FileManagerController::class, 'createUpdate'])->name('filemanager.create.update');
    
    Route::post('filemanager/create-update', [FileManagerController::class, 'createUpdatePost'])->name('filemanager.create.update.post');
    
    Route::post('filemanager/action/{id?}', [FileManagerController::class, 'applyQuickAction'])->name('filemanager.action');
    
    Route::get('filemanager/result/{companyid?}', [FileManagerController::class, 'result'])->name('filemanager.list');
    
    Route::get('filemanager/list/index/{companyidid?}/{parent_id?}', [FileManagerController::class, 'listIndex'])->name('filemanager.list.index');
    
    Route::get('filemanager/list/{companyidid?}/{parent_id?}', [FileManagerController::class, 'listResult'])->name('filemanager.list.list');
    Route::get('filemanager/list/create-update/{id?}/{type?}/{parent_id?}', [FileManagerController::class, 'listCreateUpdate'])->name('filemanager.list.create.update');
    Route::post('filemanager/list/create-update', [FileManagerController::class, 'listCreateUpdatePost'])->name('filemanager.list.create.update.post');
    //end muhssin added
